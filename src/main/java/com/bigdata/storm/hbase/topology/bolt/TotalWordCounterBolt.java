 ...
 */
package com.bigdata.storm.hbase.topology.bolt;
...
public class TotalWordCounterBolt implements IBasicBolt {

    private BigInteger total = BigInteger.ZERO;
    private static final Logger LOG = LoggerFactory.getLogger(TotalWordCounterBolt.class);
